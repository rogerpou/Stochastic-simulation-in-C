/*
------------------------------------------------------
Los parametros de trayectorias,amplitud y de pasos term casi no influyen

las trayectorias empiezan a tener una curva similar a la gráfica a partir de un tiempo de 600
...
#define tiempo (float)(600)//Tiempo final
#define dt (float)(0.0001)//Paso en tiempo
#define Dfin (float)(2)//Tiempo final
#define dD (float)(0.001)//Paso en amplitud
#define trayec (int)(10)
#define K   (float)(2*3.141592)
#define D   (float)(0)
#define omega   (float)(0.01)
#define PasosTerm (float)(50)
...
int main()
{
    ...
    for(float A=0.75;A<=Dfin;A+=dD)/*Para varias temperaturas*/
    {
        ...
        for(int k=0;k<trayec;k++)
        {
            ...
            v_med+=v/(float)((tiempo/dt)-PasosTerm);
        }
        printf("%f\t %f\t\n",A,v_med/(float)(trayec*tiempo));
